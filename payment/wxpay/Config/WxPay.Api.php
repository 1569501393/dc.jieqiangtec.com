...
// 		//如果返回成功则验证签名
// 		$_LOG[] = "获取支付数据".$xml;
// 		$_LOG[] = "获取支付数据".print_r($_POST,true);
		if(empty($xml)){
			$xml =  $_POST['xmlbody'];
		}
		try {
...
// 		curl_setopt($ch,CURLOPT_SSL_VERIFYPEER,TRUE); //hjay
// 		curl_setopt($ch,CURLOPT_SSL_VERIFYHOST,2);//严格校验 //hjay
...
// 			curl_setopt($ch,CURLOPT_SSLCERT, WxPayConfig::SSLCERT_PATH);//hjay
			curl_setopt($ch,CURLOPT_SSLCERT, SSLCERT_PATH);
			curl_setopt($ch,CURLOPT_SSLKEYTYPE,'PEM');
// 			curl_setopt($ch,CURLOPT_SSLKEY, WxPayConfig::SSLKEY_PATH);//hjay
