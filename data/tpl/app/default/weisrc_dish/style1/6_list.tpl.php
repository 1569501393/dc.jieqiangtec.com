...
<div id="wrap1">
    ...
    <div id="header" style="background-color: #d93728;background: transparent; position: relative; z-index: 99999;">
...
<div id="cart" class="cart">
    ...
    <div class="cart-tip">
        ...
        <div class="j-cart-noempty cart-noempty" <?php  if($totalprice>0) { ?>style="display: block;"<?php  } ?>>
            ...
            <span class="j-cart-price cart-price">共 ￥<font style="color:#d53527"><?php  echo $totalprice;?></font></span>
...
<div class="cart-btns">
    ...
    <a class="j-cart-btn-confirm cart-btn-confirm" <?php  if($totalprice>0) { ?>style="display:
        ...
        <span class="inner" onclick="btnSelectJump();">结算</span>
...
<div class="cart-list">
    ...
    <div class="cart-footer">
        ...
        <button class="btn1" onclick="btnSelectJump();">结算</button>

        <button class="btn2" style="background-color: #a0a0a0;display: none;">结算</button>
