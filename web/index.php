 ...
 */
define('IN_SYS', true);
require '../framework/bootstrap.inc.php';require_once '../framework/library/DbDriver/M.php';require IA_ROOT . '/web/common/bootstrap.sys.inc.php';
load()->web('common');
load()->web('template');
...
function _calc_current_frames(&$frames) {
	global $controller, $action;	if (! empty($frames['section']) && is_array($frames['section'])) {
